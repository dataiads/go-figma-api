...
// checks if the TextPathNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TextPathNode{}

// TextPathNode struct for TextPathNode
...
type _TextPathNode TextPathNode

// NewTextPathNode instantiates a new TextPathNode object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewTextPathNode(id string, name string, type_ string, scrollBehavior string, blendMode BlendMode, absoluteBoundingBox Rectangle, absoluteRenderBounds Rectangle, fills []Paint, effects []Effect, characters string, style TextPathTypeStyle, characterStyleOverrides []float32, styleOverrideTable map[string]TextPathTypeStyle) *TextPathNode {
	this := TextPathNode{}
	this.Id = id
	this.Name = name
	this.Type = type_
...
// NewTextPathNodeWithDefaults instantiates a new TextPathNode object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewTextPathNodeWithDefaults() *TextPathNode {
	this := TextPathNode{}
	var visible bool = true
	this.Visible = &visible
	var locked bool = false
...
func (o *TextPathNode) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *TextPathNode) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *TextPathNode) SetId(v string) {
	o.Id = v
}

// GetName returns the Name field value
func (o *TextPathNode) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *TextPathNode) SetName(v string) {
	o.Name = v
}

// GetType returns the Type field value
func (o *TextPathNode) GetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Type, true
...
func (o *TextPathNode) SetType(v string) {
	o.Type = v
}

// GetVisible returns the Visible field value if set, zero value otherwise.
func (o *TextPathNode) GetVisible() bool {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetVisibleOk() (*bool, bool) {
	if o == nil || IsNil(o.Visible) {
		return nil, false
	}
...
func (o *TextPathNode) HasVisible() bool {
	if o != nil && !IsNil(o.Visible) {
		return true
	}
...
func (o *TextPathNode) SetVisible(v bool) {
	o.Visible = &v
}

// GetLocked returns the Locked field value if set, zero value otherwise.
func (o *TextPathNode) GetLocked() bool {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetLockedOk() (*bool, bool) {
	if o == nil || IsNil(o.Locked) {
		return nil, false
	}
...
func (o *TextPathNode) HasLocked() bool {
	if o != nil && !IsNil(o.Locked) {
		return true
	}
...
func (o *TextPathNode) SetLocked(v bool) {
	o.Locked = &v
}

// GetIsFixed returns the IsFixed field value if set, zero value otherwise.
// Deprecated
func (o *TextPathNode) GetIsFixed() bool {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *TextPathNode) GetIsFixedOk() (*bool, bool) {
	if o == nil || IsNil(o.IsFixed) {
		return nil, false
	}
...
func (o *TextPathNode) HasIsFixed() bool {
	if o != nil && !IsNil(o.IsFixed) {
		return true
	}
...
// Deprecated
func (o *TextPathNode) SetIsFixed(v bool) {
	o.IsFixed = &v
}

// GetScrollBehavior returns the ScrollBehavior field value
func (o *TextPathNode) GetScrollBehavior() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetScrollBehaviorOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TextPathNode) SetScrollBehavior(v string) {
	o.ScrollBehavior = v
}

// GetRotation returns the Rotation field value if set, zero value otherwise.
func (o *TextPathNode) GetRotation() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetRotationOk() (*float32, bool) {
	if o == nil || IsNil(o.Rotation) {
		return nil, false
	}
...
func (o *TextPathNode) HasRotation() bool {
	if o != nil && !IsNil(o.Rotation) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetComponentPropertyReferencesOk() (map[string]string, bool) {
	if o == nil || IsNil(o.ComponentPropertyReferences) {
...
func (o *TextPathNode) HasComponentPropertyReferences() bool {
	if o != nil && !IsNil(o.ComponentPropertyReferences) {
		return true
	}
...
func (o *TextPathNode) SetComponentPropertyReferences(v map[string]string) {
...
func (o *TextPathNode) GetPluginData() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
func (o *TextPathNode) GetPluginDataOk() (*interface{}, bool) {
...
func (o *TextPathNode) HasPluginData() bool {
	if o != nil && !IsNil(o.PluginData) {
		return true
	}
...
func (o *TextPathNode) SetPluginData(v interface{}) {
	o.PluginData = v
}
...
func (o *TextPathNode) GetSharedPluginData() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *TextPathNode) GetSharedPluginDataOk() (*interface{}, bool) {
...
func (o *TextPathNode) HasSharedPluginData() bool {
	if o != nil && !IsNil(o.SharedPluginData) {
		return true
	}
...
func (o *TextPathNode) SetSharedPluginData(v interface{}) {
	o.SharedPluginData = v
}

// GetBoundVariables returns the BoundVariables field value if set, zero value otherwise.
func (o *TextPathNode) GetBoundVariables() IsLayerTraitBoundVariables {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetBoundVariablesOk() (*IsLayerTraitBoundVariables, bool) {
	if o == nil || IsNil(o.BoundVariables) {
		return nil, false
	}
...
func (o *TextPathNode) HasBoundVariables() bool {
	if o != nil && !IsNil(o.BoundVariables) {
		return true
	}
...
func (o *TextPathNode) SetBoundVariables(v IsLayerTraitBoundVariables) {
	o.BoundVariables = &v
}

// GetExplicitVariableModes returns the ExplicitVariableModes field value if set, zero value otherwise.
func (o *TextPathNode) GetExplicitVariableModes() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetExplicitVariableModesOk() (map[string]string, bool) {
	if o == nil || IsNil(o.ExplicitVariableModes) {
		return map[string]string{}, false
	}
...
func (o *TextPathNode) HasExplicitVariableModes() bool {
	if o != nil && !IsNil(o.ExplicitVariableModes) {
		return true
	}
...
func (o *TextPathNode) SetExplicitVariableModes(v map[string]string) {
	o.ExplicitVariableModes = v
}

// GetBlendMode returns the BlendMode field value
func (o *TextPathNode) GetBlendMode() BlendMode {
	if o == nil {
		var ret BlendMode
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetBlendModeOk() (*BlendMode, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TextPathNode) SetBlendMode(v BlendMode) {
	o.BlendMode = v
}

// GetOpacity returns the Opacity field value if set, zero value otherwise.
func (o *TextPathNode) GetOpacity() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetOpacityOk() (*float32, bool) {
	if o == nil || IsNil(o.Opacity) {
		return nil, false
	}
...
func (o *TextPathNode) HasOpacity() bool {
	if o != nil && !IsNil(o.Opacity) {
		return true
	}
...
func (o *TextPathNode) SetOpacity(v float32) {
	o.Opacity = &v
}

// GetAbsoluteBoundingBox returns the AbsoluteBoundingBox field value
func (o *TextPathNode) GetAbsoluteBoundingBox() Rectangle {
	if o == nil {
		var ret Rectangle
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetAbsoluteBoundingBoxOk() (*Rectangle, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TextPathNode) SetAbsoluteBoundingBox(v Rectangle) {
	o.AbsoluteBoundingBox = v
}

// GetAbsoluteRenderBounds returns the AbsoluteRenderBounds field value
func (o *TextPathNode) GetAbsoluteRenderBounds() Rectangle {
	if o == nil {
		var ret Rectangle
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetAbsoluteRenderBoundsOk() (*Rectangle, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetPreserveRatioOk() (*bool, bool) {
	if o == nil || IsNil(o.PreserveRatio) {
		return nil, false
	}
...
func (o *TextPathNode) HasPreserveRatio() bool {
	if o != nil && !IsNil(o.PreserveRatio) {
		return true
	}
...
func (o *TextPathNode) SetPreserveRatio(v bool) {
	o.PreserveRatio = &v
}

// GetConstraints returns the Constraints field value if set, zero value otherwise.
func (o *TextPathNode) GetConstraints() LayoutConstraint {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetConstraintsOk() (*LayoutConstraint, bool) {
	if o == nil || IsNil(o.Constraints) {
		return nil, false
	}
...
func (o *TextPathNode) HasConstraints() bool {
	if o != nil && !IsNil(o.Constraints) {
		return true
	}
...
func (o *TextPathNode) SetConstraints(v LayoutConstraint) {
	o.Constraints = &v
}

// GetRelativeTransform returns the RelativeTransform field value if set, zero value otherwise.
func (o *TextPathNode) GetRelativeTransform() [][]float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetRelativeTransformOk() ([][]float32, bool) {
	if o == nil || IsNil(o.RelativeTransform) {
		return nil, false
	}
...
func (o *TextPathNode) HasRelativeTransform() bool {
	if o != nil && !IsNil(o.RelativeTransform) {
		return true
	}
...
func (o *TextPathNode) SetRelativeTransform(v [][]float32) {
	o.RelativeTransform = v
}

// GetSize returns the Size field value if set, zero value otherwise.
func (o *TextPathNode) GetSize() Vector {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetSizeOk() (*Vector, bool) {
	if o == nil || IsNil(o.Size) {
		return nil, false
	}
	return o.Size, true
...
func (o *TextPathNode) HasSize() bool {
	if o != nil && !IsNil(o.Size) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetLayoutAlignOk() (*string, bool) {
	if o == nil || IsNil(o.LayoutAlign) {
		return nil, false
	}
...
func (o *TextPathNode) HasLayoutAlign() bool {
	if o != nil && !IsNil(o.LayoutAlign) {
		return true
	}
...
func (o *TextPathNode) SetLayoutAlign(v string) {
	o.LayoutAlign = &v
}

// GetLayoutGrow returns the LayoutGrow field value if set, zero value otherwise.
func (o *TextPathNode) GetLayoutGrow() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetLayoutGrowOk() (*float32, bool) {
	if o == nil || IsNil(o.LayoutGrow) {
		return nil, false
	}
...
func (o *TextPathNode) HasLayoutGrow() bool {
	if o != nil && !IsNil(o.LayoutGrow) {
		return true
	}
...
func (o *TextPathNode) SetLayoutGrow(v float32) {
	o.LayoutGrow = &v
}

// GetLayoutPositioning returns the LayoutPositioning field value if set, zero value otherwise.
func (o *TextPathNode) GetLayoutPositioning() string {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetLayoutPositioningOk() (*string, bool) {
	if o == nil || IsNil(o.LayoutPositioning) {
		return nil, false
	}
...
func (o *TextPathNode) HasLayoutPositioning() bool {
	if o != nil && !IsNil(o.LayoutPositioning) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetMinWidthOk() (*float32, bool) {
	if o == nil || IsNil(o.MinWidth) {
		return nil, false
	}
...
func (o *TextPathNode) HasMinWidth() bool {
	if o != nil && !IsNil(o.MinWidth) {
		return true
	}
...
func (o *TextPathNode) SetMinWidth(v float32) {
	o.MinWidth = &v
}

// GetMaxWidth returns the MaxWidth field value if set, zero value otherwise.
func (o *TextPathNode) GetMaxWidth() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetMaxWidthOk() (*float32, bool) {
	if o == nil || IsNil(o.MaxWidth) {
		return nil, false
	}
...
func (o *TextPathNode) HasMaxWidth() bool {
	if o != nil && !IsNil(o.MaxWidth) {
		return true
	}
...
func (o *TextPathNode) SetMaxWidth(v float32) {
	o.MaxWidth = &v
}

// GetMinHeight returns the MinHeight field value if set, zero value otherwise.
func (o *TextPathNode) GetMinHeight() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetMinHeightOk() (*float32, bool) {
	if o == nil || IsNil(o.MinHeight) {
		return nil, false
	}
...
func (o *TextPathNode) HasMinHeight() bool {
	if o != nil && !IsNil(o.MinHeight) {
		return true
	}
...
func (o *TextPathNode) SetMinHeight(v float32) {
	o.MinHeight = &v
}

// GetMaxHeight returns the MaxHeight field value if set, zero value otherwise.
func (o *TextPathNode) GetMaxHeight() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetMaxHeightOk() (*float32, bool) {
	if o == nil || IsNil(o.MaxHeight) {
		return nil, false
	}
...
func (o *TextPathNode) HasMaxHeight() bool {
	if o != nil && !IsNil(o.MaxHeight) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetLayoutSizingHorizontalOk() (*string, bool) {
	if o == nil || IsNil(o.LayoutSizingHorizontal) {
		return nil, false
	}
...
func (o *TextPathNode) HasLayoutSizingHorizontal() bool {
	if o != nil && !IsNil(o.LayoutSizingHorizontal) {
		return true
	}
...
func (o *TextPathNode) SetLayoutSizingHorizontal(v string) {
...
func (o *TextPathNode) GetLayoutSizingVertical() string {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetLayoutSizingVerticalOk() (*string, bool) {
	if o == nil || IsNil(o.LayoutSizingVertical) {
		return nil, false
	}
...
func (o *TextPathNode) HasLayoutSizingVertical() bool {
	if o != nil && !IsNil(o.LayoutSizingVertical) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridRowCountOk() (*float32, bool) {
	if o == nil || IsNil(o.GridRowCount) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridRowCount() bool {
	if o != nil && !IsNil(o.GridRowCount) {
		return true
	}
...
func (o *TextPathNode) SetGridRowCount(v float32) {
	o.GridRowCount = &v
}

// GetGridColumnCount returns the GridColumnCount field value if set, zero value otherwise.
func (o *TextPathNode) GetGridColumnCount() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridColumnCountOk() (*float32, bool) {
	if o == nil || IsNil(o.GridColumnCount) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridColumnCount() bool {
	if o != nil && !IsNil(o.GridColumnCount) {
		return true
	}
...
func (o *TextPathNode) SetGridColumnCount(v float32) {
	o.GridColumnCount = &v
}

// GetGridRowGap returns the GridRowGap field value if set, zero value otherwise.
func (o *TextPathNode) GetGridRowGap() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridRowGapOk() (*float32, bool) {
	if o == nil || IsNil(o.GridRowGap) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridRowGap() bool {
	if o != nil && !IsNil(o.GridRowGap) {
		return true
	}
...
func (o *TextPathNode) SetGridRowGap(v float32) {
	o.GridRowGap = &v
}

// GetGridColumnGap returns the GridColumnGap field value if set, zero value otherwise.
func (o *TextPathNode) GetGridColumnGap() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridColumnGapOk() (*float32, bool) {
	if o == nil || IsNil(o.GridColumnGap) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridColumnGap() bool {
	if o != nil && !IsNil(o.GridColumnGap) {
		return true
	}
...
func (o *TextPathNode) SetGridColumnGap(v float32) {
	o.GridColumnGap = &v
}

// GetGridColumnsSizing returns the GridColumnsSizing field value if set, zero value otherwise.
func (o *TextPathNode) GetGridColumnsSizing() string {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridColumnsSizingOk() (*string, bool) {
	if o == nil || IsNil(o.GridColumnsSizing) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridColumnsSizing() bool {
	if o != nil && !IsNil(o.GridColumnsSizing) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridRowsSizingOk() (*string, bool) {
	if o == nil || IsNil(o.GridRowsSizing) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridRowsSizing() bool {
	if o != nil && !IsNil(o.GridRowsSizing) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridChildHorizontalAlignOk() (*string, bool) {
	if o == nil || IsNil(o.GridChildHorizontalAlign) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridChildHorizontalAlign() bool {
	if o != nil && !IsNil(o.GridChildHorizontalAlign) {
		return true
	}
...
func (o *TextPathNode) SetGridChildHorizontalAlign(v string) {
...
func (o *TextPathNode) GetGridChildVerticalAlign() string {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridChildVerticalAlignOk() (*string, bool) {
	if o == nil || IsNil(o.GridChildVerticalAlign) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridChildVerticalAlign() bool {
	if o != nil && !IsNil(o.GridChildVerticalAlign) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridRowSpanOk() (*float32, bool) {
	if o == nil || IsNil(o.GridRowSpan) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridRowSpan() bool {
	if o != nil && !IsNil(o.GridRowSpan) {
		return true
	}
...
func (o *TextPathNode) SetGridRowSpan(v float32) {
	o.GridRowSpan = &v
}

// GetGridColumnSpan returns the GridColumnSpan field value if set, zero value otherwise.
func (o *TextPathNode) GetGridColumnSpan() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridColumnSpanOk() (*float32, bool) {
	if o == nil || IsNil(o.GridColumnSpan) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridColumnSpan() bool {
	if o != nil && !IsNil(o.GridColumnSpan) {
		return true
	}
...
func (o *TextPathNode) SetGridColumnSpan(v float32) {
	o.GridColumnSpan = &v
}

// GetGridRowAnchorIndex returns the GridRowAnchorIndex field value if set, zero value otherwise.
func (o *TextPathNode) GetGridRowAnchorIndex() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridRowAnchorIndexOk() (*float32, bool) {
	if o == nil || IsNil(o.GridRowAnchorIndex) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridRowAnchorIndex() bool {
	if o != nil && !IsNil(o.GridRowAnchorIndex) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetGridColumnAnchorIndexOk() (*float32, bool) {
	if o == nil || IsNil(o.GridColumnAnchorIndex) {
		return nil, false
	}
...
func (o *TextPathNode) HasGridColumnAnchorIndex() bool {
	if o != nil && !IsNil(o.GridColumnAnchorIndex) {
		return true
	}
...
func (o *TextPathNode) SetGridColumnAnchorIndex(v float32) {
	o.GridColumnAnchorIndex = &v
}

// GetFills returns the Fills field value
func (o *TextPathNode) GetFills() []Paint {
	if o == nil {
		var ret []Paint
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetFillsOk() ([]Paint, bool) {
	if o == nil {
		return nil, false
	}
	return o.Fills, true
...
func (o *TextPathNode) SetFills(v []Paint) {
	o.Fills = v
}

// GetStyles returns the Styles field value if set, zero value otherwise.
func (o *TextPathNode) GetStyles() map[string]string {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetStylesOk() (map[string]string, bool) {
	if o == nil || IsNil(o.Styles) {
		return map[string]string{}, false
	}
...
func (o *TextPathNode) HasStyles() bool {
	if o != nil && !IsNil(o.Styles) {
		return true
	}
...
func (o *TextPathNode) SetStyles(v map[string]string) {
	o.Styles = v
}

// GetStrokes returns the Strokes field value if set, zero value otherwise.
func (o *TextPathNode) GetStrokes() []Paint {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetStrokesOk() ([]Paint, bool) {
	if o == nil || IsNil(o.Strokes) {
		return nil, false
	}
...
func (o *TextPathNode) HasStrokes() bool {
	if o != nil && !IsNil(o.Strokes) {
		return true
	}
...
func (o *TextPathNode) SetStrokes(v []Paint) {
	o.Strokes = v
}

// GetStrokeWeight returns the StrokeWeight field value if set, zero value otherwise.
func (o *TextPathNode) GetStrokeWeight() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetStrokeWeightOk() (*float32, bool) {
	if o == nil || IsNil(o.StrokeWeight) {
		return nil, false
	}
...
func (o *TextPathNode) HasStrokeWeight() bool {
	if o != nil && !IsNil(o.StrokeWeight) {
		return true
	}
...
func (o *TextPathNode) SetStrokeWeight(v float32) {
	o.StrokeWeight = &v
}

// GetStrokeAlign returns the StrokeAlign field value if set, zero value otherwise.
func (o *TextPathNode) GetStrokeAlign() string {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetStrokeAlignOk() (*string, bool) {
	if o == nil || IsNil(o.StrokeAlign) {
		return nil, false
	}
...
func (o *TextPathNode) HasStrokeAlign() bool {
	if o != nil && !IsNil(o.StrokeAlign) {
		return true
	}
...
func (o *TextPathNode) SetStrokeAlign(v string) {
	o.StrokeAlign = &v
}

// GetStrokeJoin returns the StrokeJoin field value if set, zero value otherwise.
func (o *TextPathNode) GetStrokeJoin() string {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetStrokeJoinOk() (*string, bool) {
	if o == nil || IsNil(o.StrokeJoin) {
		return nil, false
	}
...
func (o *TextPathNode) HasStrokeJoin() bool {
	if o != nil && !IsNil(o.StrokeJoin) {
		return true
	}
...
func (o *TextPathNode) SetStrokeJoin(v string) {
	o.StrokeJoin = &v
}

// GetStrokeDashes returns the StrokeDashes field value if set, zero value otherwise.
func (o *TextPathNode) GetStrokeDashes() []float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetStrokeDashesOk() ([]float32, bool) {
	if o == nil || IsNil(o.StrokeDashes) {
		return nil, false
	}
...
func (o *TextPathNode) HasStrokeDashes() bool {
	if o != nil && !IsNil(o.StrokeDashes) {
		return true
	}
...
func (o *TextPathNode) SetStrokeDashes(v []float32) {
	o.StrokeDashes = v
}

// GetFillOverrideTable returns the FillOverrideTable field value if set, zero value otherwise.
func (o *TextPathNode) GetFillOverrideTable() map[string]HasGeometryTraitAllOfFillOverrideTable {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetFillOverrideTableOk() (map[string]HasGeometryTraitAllOfFillOverrideTable, bool) {
	if o == nil || IsNil(o.FillOverrideTable) {
...
func (o *TextPathNode) HasFillOverrideTable() bool {
	if o != nil && !IsNil(o.FillOverrideTable) {
		return true
	}
...
func (o *TextPathNode) SetFillOverrideTable(v map[string]HasGeometryTraitAllOfFillOverrideTable) {
	o.FillOverrideTable = v
}

// GetFillGeometry returns the FillGeometry field value if set, zero value otherwise.
func (o *TextPathNode) GetFillGeometry() []Path {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetFillGeometryOk() ([]Path, bool) {
	if o == nil || IsNil(o.FillGeometry) {
		return nil, false
	}
...
func (o *TextPathNode) HasFillGeometry() bool {
	if o != nil && !IsNil(o.FillGeometry) {
		return true
	}
...
func (o *TextPathNode) SetFillGeometry(v []Path) {
	o.FillGeometry = v
}

// GetStrokeGeometry returns the StrokeGeometry field value if set, zero value otherwise.
func (o *TextPathNode) GetStrokeGeometry() []Path {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetStrokeGeometryOk() ([]Path, bool) {
	if o == nil || IsNil(o.StrokeGeometry) {
		return nil, false
	}
...
func (o *TextPathNode) HasStrokeGeometry() bool {
	if o != nil && !IsNil(o.StrokeGeometry) {
		return true
	}
...
func (o *TextPathNode) SetStrokeGeometry(v []Path) {
	o.StrokeGeometry = v
}

// GetVectorNetwork returns the VectorNetwork field value if set, zero value otherwise.
func (o *TextPathNode) GetVectorNetwork() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetVectorNetworkOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.VectorNetwork) {
...
func (o *TextPathNode) HasVectorNetwork() bool {
	if o != nil && !IsNil(o.VectorNetwork) {
		return true
	}
...
func (o *TextPathNode) SetVectorNetwork(v map[string]interface{}) {
	o.VectorNetwork = v
}

// GetStrokeCap returns the StrokeCap field value if set, zero value otherwise.
func (o *TextPathNode) GetStrokeCap() string {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetStrokeCapOk() (*string, bool) {
	if o == nil || IsNil(o.StrokeCap) {
		return nil, false
	}
...
func (o *TextPathNode) HasStrokeCap() bool {
	if o != nil && !IsNil(o.StrokeCap) {
		return true
	}
...
func (o *TextPathNode) SetStrokeCap(v string) {
	o.StrokeCap = &v
}

// GetStrokeMiterAngle returns the StrokeMiterAngle field value if set, zero value otherwise.
func (o *TextPathNode) GetStrokeMiterAngle() float32 {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetStrokeMiterAngleOk() (*float32, bool) {
	if o == nil || IsNil(o.StrokeMiterAngle) {
		return nil, false
	}
...
func (o *TextPathNode) HasStrokeMiterAngle() bool {
	if o != nil && !IsNil(o.StrokeMiterAngle) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetExportSettingsOk() ([]ExportSetting, bool) {
	if o == nil || IsNil(o.ExportSettings) {
		return nil, false
	}
...
func (o *TextPathNode) HasExportSettings() bool {
	if o != nil && !IsNil(o.ExportSettings) {
		return true
	}
...
func (o *TextPathNode) SetExportSettings(v []ExportSetting) {
	o.ExportSettings = v
}

// GetEffects returns the Effects field value
func (o *TextPathNode) GetEffects() []Effect {
	if o == nil {
		var ret []Effect
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetEffectsOk() ([]Effect, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TextPathNode) SetEffects(v []Effect) {
	o.Effects = v
}

// GetIsMask returns the IsMask field value if set, zero value otherwise.
func (o *TextPathNode) GetIsMask() bool {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetIsMaskOk() (*bool, bool) {
	if o == nil || IsNil(o.IsMask) {
		return nil, false
	}
...
func (o *TextPathNode) HasIsMask() bool {
	if o != nil && !IsNil(o.IsMask) {
		return true
	}
...
func (o *TextPathNode) SetIsMask(v bool) {
	o.IsMask = &v
}

// GetMaskType returns the MaskType field value if set, zero value otherwise.
func (o *TextPathNode) GetMaskType() string {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetMaskTypeOk() (*string, bool) {
	if o == nil || IsNil(o.MaskType) {
		return nil, false
	}
...
func (o *TextPathNode) HasMaskType() bool {
	if o != nil && !IsNil(o.MaskType) {
		return true
	}
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *TextPathNode) GetIsMaskOutlineOk() (*bool, bool) {
	if o == nil || IsNil(o.IsMaskOutline) {
		return nil, false
	}
...
func (o *TextPathNode) HasIsMaskOutline() bool {
	if o != nil && !IsNil(o.IsMaskOutline) {
		return true
	}
...
// Deprecated
func (o *TextPathNode) SetIsMaskOutline(v bool) {
	o.IsMaskOutline = &v
}

// GetTransitionNodeID returns the TransitionNodeID field value if set, zero value otherwise.
func (o *TextPathNode) GetTransitionNodeID() string {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetTransitionNodeIDOk() (*string, bool) {
	if o == nil || IsNil(o.TransitionNodeID) {
		return nil, false
	}
...
func (o *TextPathNode) HasTransitionNodeID() bool {
	if o != nil && !IsNil(o.TransitionNodeID) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetTransitionDurationOk() (*float32, bool) {
	if o == nil || IsNil(o.TransitionDuration) {
		return nil, false
	}
...
func (o *TextPathNode) HasTransitionDuration() bool {
	if o != nil && !IsNil(o.TransitionDuration) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetTransitionEasingOk() (*EasingType, bool) {
	if o == nil || IsNil(o.TransitionEasing) {
		return nil, false
	}
...
func (o *TextPathNode) HasTransitionEasing() bool {
	if o != nil && !IsNil(o.TransitionEasing) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetInteractionsOk() ([]Interaction, bool) {
	if o == nil || IsNil(o.Interactions) {
		return nil, false
	}
...
func (o *TextPathNode) HasInteractions() bool {
	if o != nil && !IsNil(o.Interactions) {
		return true
	}
...
func (o *TextPathNode) SetInteractions(v []Interaction) {
	o.Interactions = v
}

// GetCharacters returns the Characters field value
func (o *TextPathNode) GetCharacters() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetCharactersOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *TextPathNode) SetCharacters(v string) {
	o.Characters = v
}

// GetStyle returns the Style field value
func (o *TextPathNode) GetStyle() TextPathTypeStyle {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetStyleOk() (*TextPathTypeStyle, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Style, true
...
func (o *TextPathNode) SetStyle(v TextPathTypeStyle) {
	o.Style = v
}

// GetCharacterStyleOverrides returns the CharacterStyleOverrides field value
func (o *TextPathNode) GetCharacterStyleOverrides() []float32 {
	if o == nil {
		var ret []float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetCharacterStyleOverridesOk() ([]float32, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetLayoutVersionOk() (*float32, bool) {
	if o == nil || IsNil(o.LayoutVersion) {
		return nil, false
	}
...
func (o *TextPathNode) HasLayoutVersion() bool {
	if o != nil && !IsNil(o.LayoutVersion) {
		return true
	}
...
func (o *TextPathNode) SetLayoutVersion(v float32) {
	o.LayoutVersion = &v
}

// GetStyleOverrideTable returns the StyleOverrideTable field value
func (o *TextPathNode) GetStyleOverrideTable() map[string]TextPathTypeStyle {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *TextPathNode) GetStyleOverrideTableOk() (map[string]TextPathTypeStyle, bool) {
	if o == nil {
...
func (o *TextPathNode) SetStyleOverrideTable(v map[string]TextPathTypeStyle) {
	o.StyleOverrideTable = v
}

func (o TextPathNode) MarshalJSON() ([]byte, error) {
...
func (o TextPathNode) ToMap() (map[string]interface{}, error) {
...
func (o *TextPathNode) UnmarshalJSON(data []byte) (err error) {
	...
	varTextPathNode := _TextPathNode{}

	err = json.Unmarshal(data, &varTextPathNode)

	if err != nil {
		return err
	}

	*o = TextPathNode(varTextPathNode)
...
type NullableTextPathNode struct {
	value *TextPathNode
	isSet bool
}

func (v NullableTextPathNode) Get() *TextPathNode {
	return v.value
}

func (v *NullableTextPathNode) Set(val *TextPathNode) {
	v.value = val
	v.isSet = true
}

func (v NullableTextPathNode) IsSet() bool {
	return v.isSet
}

func (v *NullableTextPathNode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTextPathNode(val *TextPathNode) *NullableTextPathNode {
	return &NullableTextPathNode{value: val, isSet: true}
}

func (v NullableTextPathNode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTextPathNode) UnmarshalJSON(src []byte) error {
	v.isSet = true
