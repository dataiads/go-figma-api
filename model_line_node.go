...
func (o *LineNode) GetVectorNetwork() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *LineNode) GetVectorNetworkOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.VectorNetwork) {
...
func (o *LineNode) HasVectorNetwork() bool {
	if o != nil && !IsNil(o.VectorNetwork) {
		return true
	}
...
func (o *LineNode) SetVectorNetwork(v map[string]interface{}) {
	o.VectorNetwork = v
}
...
func (o *LineNode) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varLineNode)
