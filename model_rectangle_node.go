...
func (o *RectangleNode) GetVectorNetwork() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *RectangleNode) GetVectorNetworkOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.VectorNetwork) {
...
func (o *RectangleNode) HasVectorNetwork() bool {
	if o != nil && !IsNil(o.VectorNetwork) {
		return true
	}
...
func (o *RectangleNode) SetVectorNetwork(v map[string]interface{}) {
	o.VectorNetwork = v
}
...
func (o *RectangleNode) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varRectangleNode)
