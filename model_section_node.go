...
func (o *SectionNode) GetVectorNetwork() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *SectionNode) GetVectorNetworkOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.VectorNetwork) {
...
func (o *SectionNode) HasVectorNetwork() bool {
	if o != nil && !IsNil(o.VectorNetwork) {
		return true
	}
...
func (o *SectionNode) SetVectorNetwork(v map[string]interface{}) {
	o.VectorNetwork = v
}
