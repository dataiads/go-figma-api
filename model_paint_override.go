...
type _PaintOverride PaintOverride
...
func (o *PaintOverride) UnmarshalJSON(data []byte) (err error) {
	varPaintOverride := _PaintOverride{}

	err = json.Unmarshal(data, &varPaintOverride)

	if err != nil {
		return err
	}

	*o = PaintOverride(varPaintOverride)
