...
func (o *TextNode) GetVectorNetwork() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *TextNode) GetVectorNetworkOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.VectorNetwork) {
...
func (o *TextNode) HasVectorNetwork() bool {
	if o != nil && !IsNil(o.VectorNetwork) {
		return true
	}
...
func (o *TextNode) SetVectorNetwork(v map[string]interface{}) {
	o.VectorNetwork = v
}
...
func (o *TextNode) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTextNode)
