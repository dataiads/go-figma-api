...
// checks if the LinkUnfurlNode type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LinkUnfurlNode{}
...
type _LinkUnfurlNode LinkUnfurlNode
...
func (o LinkUnfurlNode) MarshalJSON() ([]byte, error) {
...
func (o LinkUnfurlNode) ToMap() (map[string]interface{}, error) {
...
func (o *LinkUnfurlNode) UnmarshalJSON(data []byte) (err error) {
	...
	varLinkUnfurlNode := _LinkUnfurlNode{}

	err = json.Unmarshal(data, &varLinkUnfurlNode)

	if err != nil {
		return err
	}

	*o = LinkUnfurlNode(varLinkUnfurlNode)
...
type NullableLinkUnfurlNode struct {
	value *LinkUnfurlNode
	isSet bool
}

func (v NullableLinkUnfurlNode) Get() *LinkUnfurlNode {
	return v.value
}

func (v *NullableLinkUnfurlNode) Set(val *LinkUnfurlNode) {
	v.value = val
	v.isSet = true
}

func (v NullableLinkUnfurlNode) IsSet() bool {
	return v.isSet
}

func (v *NullableLinkUnfurlNode) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLinkUnfurlNode(val *LinkUnfurlNode) *NullableLinkUnfurlNode {
	return &NullableLinkUnfurlNode{value: val, isSet: true}
}

func (v NullableLinkUnfurlNode) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLinkUnfurlNode) UnmarshalJSON(src []byte) error {
	v.isSet = true
